=> 0x0000000000400fce <+0>:	sub    $0x8,%rsp
   0x0000000000400fd2 <+4>:	mov    %edx,%eax             input 1 = eax
   0x0000000000400fd4 <+6>:	sub    %esi,%eax             subtract esi from eax
   ...
   0x0000000000400fe4 <+22>:	jle    0x400ff2 <func4+36>   jump to +36 else
   0x0000000000400fe6 <+24>:	lea    -0x1(%rcx),%edx       edx = rcx - 1
   0x0000000000400fe9 <+27>:	callq  0x400fce <func4>
   0x0000000000400fee <+32>:	add    %eax,%eax             double eax
   0x0000000000400ff0 <+34>:	jmp    0x401007 <func4+57>   exit func4
   0x0000000000400ff2 <+36>:	mov    $0x0,%eax             0 eax
   0x0000000000400ff7 <+41>:	cmp    %edi,%ecx             if ecx >= edi
   0x0000000000400ff9 <+43>:	jge    0x401007 <func4+57>    exit func4
